...
#define ANCHOR_A_Y   -892
#define ANCHOR_A_Z   -194
#define ANCHOR_B_X   768
#define ANCHOR_B_Y   453
#define ANCHOR_B_Z   -181
#define ANCHOR_C_X   -768
#define ANCHOR_C_Y   453
#define ANCHOR_C_Z   -229
#define ANCHOR_D_Z   1343
...
#define ACTION_POINTS_A 1
#define ACTION_POINTS_B 1
#define ACTION_POINTS_C 1
...
const float MOUNTED_LINE[DIRS] = {10000.0,1000.0,1000.0,1000.0};

// Measuring your spool radii and adjusting this number will improve your Hangprinter's precision
const float SPOOL_RADII[DIRS] = { 54.85596, 55.05089, 54.95703, 55.0 };
...
const float STEPS_PER_SPOOL_RADIAN[DIRS] = {5093, 5093.0, 5093.0, 2252.58};
...
#define INVERT_X_DIR true // INVERT_A
#define INVERT_Y_DIR true  // INVERT_B
#define INVERT_Z_DIR true // INVERT_C

#define INVERT_E0_DIR false   // INVERT_E
#define INVERT_E1_DIR false    // INVERT_D
...
#define DEFAULT_ESTEPS 35 // 410.0 set quite at random
#if defined(EXPERIMENTAL_LINE_BUILDUP_COMPENSATION_FEATURE)
#define DEFAULT_AXIS_STEPS_PER_UNIT   {0, 0, 0, 0, DEFAULT_ESTEPS}
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {101.859, 101.859, 101.859, 159.915, DEFAULT_ESTEPS}
#endif
